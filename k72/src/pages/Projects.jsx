  ...
  return (
    <div className='lg:p-4 p-2 mb-[100vh]'>
        <div className=' pt-[45vh]'>
            <h2 className='font-[font2] text-[9.5vw] text-7xl uppercase'>Projets</h2>
        </div>
        <div className='-lg:-mt-16 lol'>
          {projects.map(function (elem, idx){
            return(
                  <div key={idx} className='hero w-full h-[620px] mb-4 flex lg:flex-row flex-col lg:gap-4 gap-2'>
