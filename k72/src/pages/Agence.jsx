...
import Expertise from "../components/agence/Expertise";
import Para1 from "../components/agence/Para1";
import List from "../components/agence/List";
import Para2 from "../components/agence/Para2";
import EmptyDiv from "../components/agence/EmptyDiv";
import Para3 from "../components/agence/Para3";
  ...
  return (
    <div>
      ...
      <div className="section1 py-1">
        ...
        <div
          ref={imageDivRef}
          className="absolute overflow-hidden h-[20vw] rounded-3xl w-[15vw] top-38 left-[30vw]"
        >
          {" "}
          <img
            ref={imageRef}
